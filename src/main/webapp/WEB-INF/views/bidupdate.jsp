...
<body>
	...
	<div id="content">
		<h6>content</h6>
			<form action="bidupdateprocess" method="post">
				<input type="hidden" name="bidnumber" value="${bid.bidnumber}">
				입찰 금액<input type="text" name="bidprice" id="bidprice" placeholder="기존금액 ${bid.bidprice}원" />원 <br>
				...
				<br>
				<input type="submit" value="구매 입찰 등록">
			</form>
	</div>
</body>
</html>