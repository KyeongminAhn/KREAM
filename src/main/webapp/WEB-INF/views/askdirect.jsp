	...
	<div id="content">
		...
		<div id="input">
			<c:if test="${sessionScope.loginMember != 'admin'}">
				<h5>즉시 판매 금액, 사이즈 입력</h5>
					<form action="biddirect" method="post">
						<input type="hidden" name="obidid" value="${sessionScope.loginMember}" >
						<input type="hidden" name="opnumber" value="${product.pnumber}" >
						구매 금액<input type="text" name="oprice" id="oprice" placeholder="금액을 입력하세요" />원 <br>
						240<input type="radio" id="osize" name="osize" value="240">
						250<input type="radio" id="osize" name="osize" value="250">
						260<input type="radio" id="osize" name="osize" value="260">
						270<input type="radio" id="osize" name="osize" value="270">
						<br>
						<input type="submit" value="즉시 구매">
					</form>
			</c:if>
		</div>
	</div>
